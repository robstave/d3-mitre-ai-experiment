...
const margins = { top: 50, right: 50, bottom: 50, left: 200 }; // Increased left margin
...
function drawRadarChart(data, maxValue) {
    ...
    radarLine.join(
        enter => enter.append("path")
            ...
            .attr("fill", "none")
            .attr("stroke", colorScale(maxValueInData))
            .attr("stroke-width", 2)
...
function drawBarChart(data, maxValue) {
    ...
    // Add color legend
    addColorLegend(colorScale, xScaleBar, maxValue);
}
